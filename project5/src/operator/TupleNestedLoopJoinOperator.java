...
//		System.out.println("leftSchema:"+opLeft.getSchema());
//		System.out.println("rightSchema:"+opRight.getSchema());
		//       update schema
...
//			System.out.println("joinCondition:"+joinedCondition);
	...
	public String printPhysicalTree() {
		String expression = (joinedCondition != null) ? joinedCondition.toString() : "null";
	...
	public void printTree(PrintStream ps, int lv) {
		...
		leftOp.printTree(ps, lv + 1);
		rightOp.printTree(ps, lv + 1);
	}
}
